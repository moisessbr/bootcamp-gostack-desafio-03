...
API desenvolvida para o Desafio 03 do Bootcamp GoStack 7.0 da Rocketseat.

## Resumo

Aplicação feita utilizando Node + Express. Banco de dados Postgre com Sequelize.

Estruturada no padrão MVC.

## Dependências

Principais dependências e breve resumo.

### Bcrypt e JSONWebToken - JWT

Criação do Hash de senha e do Token
...
Biblioteca para a utilização de variáveis de ambiente.

### Express

Criação das rodas da aplicação.

### Express-Async-Errors, Express-Handblebars

Tratamento de erros do Express.

### Nodemailer e Nodemailer-Express-Handlebars

Envio de e-mails e tratamento de erros.
